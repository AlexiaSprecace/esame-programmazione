...
public class FilterExtension extends Filter {
	...
	/**
	 * Override of the {@link it.univpm.esameOOP.util.other.Filter#doFilter(it.univpm.esameOOP.model.SharedFile)}, which checks if the file's extension is the specified one
